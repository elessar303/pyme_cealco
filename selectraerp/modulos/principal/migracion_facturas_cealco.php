...
foreach ($select_det as $det) {//Detalle de la factura
	...
	$inser_det_siga="INSERT INTO faartfacpro(reffac, codart, desart, codref, cantot, precio, monrgo, mondes, totart, estatus) VALUES ('".$ref."','".$det['codigo_barras']."','".$det['descripcion1']."','".$ref."', '".$det['cantidad_total']."','".number_format($det['precio'],3,'.','')."',0,'0.00','".$total_siniva."', 'A');\r\n";
    echo $inser_det_siga;
}
exit();