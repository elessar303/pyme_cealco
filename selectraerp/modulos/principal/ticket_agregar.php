...
$conductores = $comunes->ObtenerFilasBySqlSelect("SELECT *  from conductores");
$arraySelectOption2="";
$arraySelectOutPut2="";

foreach ($conductores as $key => $conductor) 
{
    $arraySelectOption2[] = $conductor["id_conductor"];
    $arraySelectOutPut2[] = utf8_encode($conductor["cedula_conductor"]." - ".$conductor["nombre_conductor"]);
}
