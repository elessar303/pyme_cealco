...
$comunes = new Comunes();
$tabla = $name_form = "transporte_modelo";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("ID","Descripcion"));
...
//**************************************************************************
$smarty->assign("option_values", array("id","descripcion_modelo"));
$smarty->assign("option_output", array("ID","Modelo"));
