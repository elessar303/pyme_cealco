...
$comunes = new Comunes();
$tabla = $name_form = "transporte_camion";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
$smarty->assign("cabecera",array("Placa","Unidad", "Serial GPS"));
...
//**************************************************************************
$smarty->assign("option_values", array("placa","unidad", "serial_gps"));
$smarty->assign("option_output", array("Placa","Unidad","Serial GPS"));
