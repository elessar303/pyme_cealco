...
//*********************************JUNIOR AYALA**************************************************       
    ...
    {
        $sql="INSERT INTO `item`(`id_item` , `cod_item`, `cod_item_forma`, `codigo_barras` , `descripcion1` ,  `unidad_empaque` ,  `seriales` ,  `cod_departamento` ,  `cod_grupo` , `cantidad_bulto` ,  `kilos_bulto` ,  `id_marca` ,  `unidadxpeso` ,  `unidad_venta` , `pesoxunidad` ,  `producto_vencimiento`, `iva`, `produccion`, `estatus`, `precio1`,`precio2`,`precio3`,`costo_actual`) VALUES ('".$value['id_item']."','".$value['cod_item']."','".$value['cod_item_forma']."', '".$value['codigo_barras']."','".$value['descripcion1']."','".$value['unidad_empaque']."', '".$value['seriales']."', '".$value['cod_departamento']."', '".$value['cod_grupo']."', '".$value['cantidad_bulto']."', '".$value['kilos_bulto']."','".$value['id_marca']."','".$value['unidadxpeso']."','".$value['unidad_venta']."','".$value['pesoxunidad']."','".$value['producto_vencimiento']."','".$value['iva']."','".$value['sae']."', '".$value['estatus']."','".$value['precio1']."','".$value['precio2']."','".$value['precio3']."','".$value['costo_actual']."')";
        $comunes->Execute2($sql);
    }
