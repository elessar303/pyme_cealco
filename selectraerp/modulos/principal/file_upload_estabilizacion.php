...
//*********************************JUNIOR AYALA**************************************************       
    ...
    {
        $sql="INSERT INTO `item`(`id_item` , `cod_item_forma`, `codigo_barras` , `descripcion1` ,  `unidad_empaque` ,  `seriales` ,  `cod_departamento` ,  `cod_grupo` , `cantidad_bulto` ,  `kilos_bulto` ,  `id_marca` ,  `unidadxpeso` ,  `unidad_venta` , `pesoxunidad` ,  `producto_vencimiento`, `iva`, `produccion`) VALUES ('".$value['id_item']."','".$value['cod_item_forma']."', '".$value['codigo_barras']."','".$value['descripcion1']."','".$value['unidad_empaque']."', '".$value['seriales']."', '".$value['cod_departamento']."', '".$value['cod_grupo']."', '".$value['cantidad_bulto']."', '".$value['kilos_bulto']."','".$value['id_marca']."','".$value['unidadxpeso']."','".$value['unidad_venta']."','".$value['pesoxunidad']."','".$value['producto_vencimiento']."','".$value['iva']."','".$value['sae']."', '".$value['cod_item_forma']."')";
        $comunes->Execute2($sql);
    }
