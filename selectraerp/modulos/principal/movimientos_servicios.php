...
if(isset($_POST['buscar']) || $tipob!=NULL){
    ...
    $instruccion = "SELECT * FROM tipo_movimiento_almacen a group by movimiento_servicio";
}
...
//**************************************************************************
$smarty->assign("option_values", array("movimiento_servicio","descripcion"));
$smarty->assign("option_output", array("Cod. Movimie","Descripción Servicio"));
