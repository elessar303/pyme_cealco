...
$comunes = new Comunes();
$tabla = $name_form = "ubicacion_servicio a, item  b";
$tipob=@$_GET['tipo'];
$des=@$_GET['des'];
$pagina=@$_GET['pagina'];
...
if(isset($_POST['buscar']) || $tipob!=NULL){
    ...
    $instruccion = "SELECT * FROM ubicacion_servicio a, item as b where a.id_ubicacion= ".$_GET["id"]. " and a.id_servicio=b.id_item";
}
