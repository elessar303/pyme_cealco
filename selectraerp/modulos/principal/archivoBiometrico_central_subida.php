...
while ($archivo = $directorio->read()) {
    ...
    if (substr($archivo,0,1)!=".") {
        ...
        while($filas[$i]!=NULL) {
            ...
            $boorar="DELETE from ".$pymeC.".".$ventas_anno." where codigo_siga='000".$values[61]."' and id_tickets='".$values[0]."' and CODE='".$values[16]."'";
            $boorar_duplicado=$comunes->ExecuteTrans($boorar);
