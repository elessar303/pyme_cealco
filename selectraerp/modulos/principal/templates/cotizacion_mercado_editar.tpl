                        ...
                        <div id="div_tab1">
                            <div class="grid">
                                <table class="lista" style="width:100%;">
                                    ...
                                    <tbody>
                                    <!-- {if $id_estudio neq ""}
                                        {foreach from=$productos_editar key=j item=edita}
                                            <tr>
                                                <td>{$edita.descripcion1}</td>
                                                <td>{$edita.costo_sin_iva}</td>
                                                <td>{$edita._costo_iva}</td>
                                                <td>{$edita._precio_sugerido}</td>
                                                <td>{$edita._margen_ganancia}</td>
                                                <td>{$edita._pvp}</td>
                                                <td>{$edita.estatus_name}</td>
