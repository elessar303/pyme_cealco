            ...
            $(document).ready(function()
            {
                ...
                function cargarUbicaciones() 
                {
                    ...
                    if(idAlmacen!=0)
                    {
                        $.ajax({
                            type: 'POST',
                            data: 'opt=cargaUbicacion4&idAlmacen='+idAlmacen,
                            ...
                            success: function(data) {
                                ...
                                {
                                    $("#ubicacion").append("<option value='-1'>Sin Resultados</option>");
                                }
                ...
                <input type="hidden" name="tiene_filtro" id="tiene_filtro" value="1"/>
                    <table style="width:100%; background-color:white;">
                        ...
                        <tbody>
                            ...
                            <tr class="tb-head">
                                <td colspan="10">
                                    <input type="submit" id="enviarajax" name="aceptar" value="Agregar"/>
