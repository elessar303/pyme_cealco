        ...
        <style type="text/css">
            ...
            $(document).ready(function(){
                ...
                marca_producto=$("#marca_producto").val();
                    ...
                    $.ajax({
                            type: 'GET',
                            data: "opt=reporte_productoCentral&punto="+punto+"&estados="+estados+"&desde="+desde+"&hasta="+hasta+"&categoria="+categoria+"&producto="+producto+"&tipo_punto="+tipo_punto+"&tipo_almacenamiento="+tipo_almacenamiento+"&marca_producto="+marca_producto,
