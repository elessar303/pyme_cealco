...
<html>
    ...
    <body>
        <form name="formulario" id="formulario" method="post" action="">
            ...
            <div id="dp" class="x-hide-display">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="test" name="nro_cotizacion" id="nro_cotizacion" maxlength="100" size="30" class="form-text">
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input type="text" name="input_fechacotiza" id="input_fechacotiza" value='{$smarty.now|date_format:"%Y-%m-%d"}' size="30" maxlength="70" class="form-text" readonly="readonly"/>
                    ...
                    <tr>
                        ...
                        <td colspan="5" style="padding-top:2px; padding-bottom: 2px;">
                            <input type="date" name="fecha_cotizacion" step="1" value='{$smarty.now|date_format:"%Y-%m-%d"}' class="form-text" />
                    ...
                    <tr>
                        ...
                        <td colspan="5" style="padding-top:2px; padding-bottom: 2px;">
                            <input type="date" name="validez_fecha" step="1" value='{$smarty.now|date_format:"%Y-%m-%d"}' class="form-text" />
                            <!--button id="boton_fecha">...</button-->
                            <!--<input type="text" name="fecha2" id="fecha2" size="20" value='{$smarty.now|date_format:"%d-%m-%Y"}' readonly class="form-text" />-->
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <select id="tipo_transporte" name="tipo_transporte" class="form-text" style="width:205px">
                                ...
                                {html_options values=$option_values_id_transporte output=$option_output_transporte_name}
                            </select>
                        </td>
                    </tr>
            ...
            <!-- A PARTIR DE ESTE PUNTO, NO SE USARA LO QUE SE ENCUENTRA DEBAJO, YA QUE SOLO SERA REFERENCIAL, PUESTO QUE SOLO SE ESTARA CREANDO Y/O EDITANDO LA CABECERA DE LA COTIZACION.

            LUEGO VERE SI BORRO TODO ESTO
            HZ -->
