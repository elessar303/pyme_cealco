...
while ($archivo = $directorio->read()) {
    ...
    if (substr($archivo,0,1)!=".") {
        ...
        while($filas[$i]!=NULL) {
            ...
            /*
            $sql ="INSERT INTO ".$pymeC.".".$ventas_mes_anno."(id_tickets(0), TICKETTYPE(1), TICKETID(2), PERSON(3), CUSTOMER(4), STATUS(5), TICKET(6), 
              LINE(7), PRODUCT(8), ATTRIBUTESETINSTANCE_ID(9), UNITS(10), PRICE(11), taxid_tikestline(12), datenew_ticketlines(13), id_products(14), REFERENCE(15), CODE(16), CODETYPE(17),
                   nombre_producto(18), PRICEBUY(19), PRICESELL(20), CATEGORY(21), TAXCAT(22), ATTRIBUTESET_ID(23), STOCKCOST(24), STOCKVOLUME(25), ISCOM(26), ISSCALE(27), QUANTITY_MAX(28),
                   TIME_FOR_TRY(29), id_gente(30), SEARCHKEY(31), TAXID(32), name_persona(33), TAXCATEGORY(34), CARD(35), MAXDEBT(36), ADDRESS(37), ADDRESS2(38), POSTAL(39), CITY(40),
                   REGION(41), COUNTRY(24), FIRSTNAME(43), LASTNAME(44), EMAIL(45), PHONE(46), PHONE2(47), FAX(48), NOTES(49), visible(50), CURDATE(51), CURDEBT(52), id_receipts(53),
                   money_receipts(54), DATENEW(55), MONEY(56), HOST(57), HOSTSEQUENCE(58), DATESTART(59), DATEEND(60), categoria_conversor(61), id_categoria_pos(62), cod_categoria(63), codigo_siga(64))
            ...
            */
            $sql ="INSERT INTO ".$pymeC.".".$ventas_anno."(`id_tickets`, `UNITS`, `PRICE`, `datenew_ticketlines`, `CODE`, `nombre_producto`, `PRICEBUY`, 
              `PRICESELL`, `TAXCAT`, `SEARCHKEY`, `name_persona`, `DATENEW`, `MONEY`, 
              `HOST`, `HOSTSEQUENCE`, `DATESTART`, `DATEEND`, `categoria_conversor`, `id_categoria_pos`, `cod_categoria`, `codigo_siga`)
                  VALUES ('".$values[0]."','".$values[10]."','".$values[11]."','".$values[13]."','".$values[16]."','".$values[18]."','".$values[19]."',
                   '".$values[20]."','".$values[22]."','".$values[31]."','".$values[33]."','".$values[55]."','".$values[56]."',
                  '".$values[57]."','".$values[58]."','".$values[59]."','".$values[60]."','NULL',
                  'NULL','NULL','000".$values[61]."')"; 
            //echo $archivo; 
            ...
            //  $sql ="INSERT INTO ".$pymeC.".".$ventas_anno."(`id_tickets`, `UNITS`, `PRICE`, `datenew_ticketlines`, `CODE`, `nombre_producto`, `PRICEBUY`, `PRICESELL`, `TAXCAT`, `SEARCHKEY`, `name_persona`, `DATENEW`, `MONEY`, `HOST`, `HOSTSEQUENCE`, `DATESTART`, `DATEEND`, `categoria_conversor`, `id_categoria_pos`, `cod_categoria`, `codigo_siga`)               SELECT `id_tickets`, `UNITS`, `PRICE`, `datenew_ticketlines`, `CODE`, `nombre_producto`, `PRICEBUY`, `PRICESELL`, `TAXCAT`, `SEARCHKEY`, `name_persona`, `DATENEW`, `MONEY`, `HOST`, `HOSTSEQUENCE`, `DATESTART`, `DATEEND`, `categoria_conversor`, `id_categoria_pos`, `cod_categoria`, `codigo_siga` FROM ".$pymeC.".".$ventas_mes_anno." where codigo_siga='000".$values[61]."' and id_tickets='".$values[0]."' and CODE='".$values[16]."'"; 
