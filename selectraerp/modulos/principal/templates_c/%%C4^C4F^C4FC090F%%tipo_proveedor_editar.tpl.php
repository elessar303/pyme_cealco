<?php /* Smarty version 2.6.21, created on 2017-08-24 11:22:51
         compiled from tipo_proveedor_editar.tpl */ ?>
<?php echo '
...
<tr>
    ...
    <td >
        <input type="text" readonly name="id_pclasif" value="<?php echo $this->_tpl_vars['datos_banco'][0]['id_pclasif']; ?>
" id="id_pclasif">
    </td>
</tr>
<tr>
    ...
    <td >
        <input type="text" name="clasificacion" value="<?php echo $this->_tpl_vars['datos_banco'][0]['clasificacion']; ?>
" size="60" id="clasificacion" >
    </td>
</tr>
</table>
