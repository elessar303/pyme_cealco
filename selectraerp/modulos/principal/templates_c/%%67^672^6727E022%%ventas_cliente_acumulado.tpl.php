<?php /* Smarty version 2.6.21, created on 2017-08-28 15:40:31
         compiled from ventas_cliente_acumulado.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ventas_cliente_acumulado.tpl', 342, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <style type="text/css">
            ...
            $(document).ready(function(){
                ...
                codigo_barras=$("#codigo_barras").val();
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_establecimientoCentral_acumulado&estados="+estados+"&desde="+desde+"&hasta="+hasta+"&punto="+punto+"&tipo_almacenamiento="+tipo_almacenamiento+"&codigo_barras="+codigo_barras,
...
"/>
                ...
                <input type="hidden" name="estados" id="estados" value="0"/>
                <input type="hidden" name="tipo_almacenamiento" id="tipo_almacenamiento" value="0"/>
