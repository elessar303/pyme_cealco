<?php /* Smarty version 2.6.21, created on 2017-07-05 12:51:53
         compiled from reporte_distribucion_transporte.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'reporte_distribucion_transporte.tpl', 180, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
            ...
            function validacion()
                {
                    ...
                    document.formulario.action = "../../reportes/reporte_distribucion_transporte.php";
...
"/>
                ...
                <table style="width:100%; background-color:white;" align="center" border="0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="label">Placa Camión</td>
                            <td colspan="3" style="padding-top:2px; padding-bottom: 2px;">
                                <input type="text" name="placa" placeholder="Placa" size="60" id="placa" class="form-text"/>
                            </td>
                        </tr>

                        <tr>
                            <td class="label">Cedula Conductor</td>
                            <td colspan="3" style="padding-top:2px; padding-bottom: 2px;">
                                <input type="text" name="cedula" placeholder="Cedula" size="60" id="cedula" class="form-text"/>
                            </td>
                        </tr>

                        <tr>
                            <td class="label">Estado Distribución</td>
                            <td colspan="3" style="padding-top:2px; padding-bottom: 2px;">
