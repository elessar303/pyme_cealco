<?php /* Smarty version 2.6.21, created on 2017-08-26 12:37:28
         compiled from rep_trans_rango.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rep_trans_rango.tpl', 163, false),array('function', 'html_options', 'rep_trans_rango.tpl', 187, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <style type="text/css">
            ...
            $(document).ready(function(){
                ...
                tipo_punto=$("#tipo_punto").val();
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=rep_trans_rango&punto="+punto+"&estados="+estados+"&desde="+desde+"&hasta="+hasta,
