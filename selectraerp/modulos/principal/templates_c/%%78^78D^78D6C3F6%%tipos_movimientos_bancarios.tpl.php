<?php /* Smarty version 2.6.21, created on 2017-08-24 11:41:03
         compiled from tipos_movimientos_bancarios.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'tipos_movimientos_bancarios.tpl', 60, false),)), $this); ?>
<?php echo '
...
?>
    ...
    <?php else: ?>
        <tr  bgcolor="#e1e1e1">
    <?php endif; ?>
        <td ><?php echo $this->_tpl_vars['campos']['cod_tipo_movimientos_ban']; ?>
</td>
...
&opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&opt_subseccion=edit&cod=<?php echo $this->_tpl_vars['campos']['cod_tipo_movimientos_ban']; ?>
...
&opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&opt_subseccion=delete&cod=<?php echo $this->_tpl_vars['campos']['cod_tipo_movimientos_ban']; ?>
