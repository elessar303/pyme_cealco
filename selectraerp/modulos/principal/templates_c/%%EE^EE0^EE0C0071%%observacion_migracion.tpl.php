<?php /* Smarty version 2.6.21, created on 2017-08-28 15:22:39
         compiled from observacion_migracion.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'observacion_migracion.tpl', 371, false),array('function', 'html_options', 'observacion_migracion.tpl', 383, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
...
/*Fin de la segunda prueba*/
            ...
            $(document).ready(function(){
                ...
                codigo_barras=$("#codigo_barras").val();
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=observacion_migracion&punto="+punto+"&estados="+estados+"&desde="+desde+"&hasta="+hasta,
