<?php /* Smarty version 2.6.21, created on 2017-08-25 13:01:59
         compiled from inventario_estab_central.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'inventario_estab_central.tpl', 362, false),array('function', 'html_options', 'inventario_estab_central.tpl', 374, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
               ...
               $("input[name=\'buscar\']").click(function(){
                ...
                /*if(punto==\'0\'){
                  ...
                  exit;
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_inventarioCentralEstab&fecha="+fecha+"&ubicacion="+ubicacion+"&categoria="+categoria+"&tipo_punto="+tipo_punto+"&codigo_barras="+codigo_barras,
