<?php /* Smarty version 2.6.21, created on 2017-08-28 16:14:59
         compiled from rpt_venta_productos13_2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpt_venta_productos13_2.tpl', 434, false),array('function', 'html_options', 'rpt_venta_productos13_2.tpl', 458, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <style type="text/css">
            ...
            $(document).ready(function(){
                ...
                codigo_barras=$("#codigo_barras").val();*/
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_productoInexistenteCentral&punto="+punto+"&estados="+estados+"&desde="+desde+"&hasta="+hasta+"&codigo_barras="+codigo_barras,
...
' readonly class="form-text" />
                        ...
                        <!--<tr>
                           COMENTADO LOS BLOQUES DE ABAJO PARA PRUEBAS -->
