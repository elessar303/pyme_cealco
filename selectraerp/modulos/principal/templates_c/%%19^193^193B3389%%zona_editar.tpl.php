<?php /* Smarty version 2.6.21, created on 2017-08-24 11:37:09
         compiled from zona_editar.tpl */ ?>
<?php echo '
...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_zona" value="<?php echo $this->_tpl_vars['datos_zona'][0]['cod_zona']; ?>
" id="cod_zona" >
    </td>
</tr>
<tr>
    ...
    <td >
        <input type="text" name="descripcion_zona" value="<?php echo $this->_tpl_vars['datos_zona'][0]['descripcion']; ?>
" size="60" id="descripcion_zona" >
    </td>
</tr>
</table>
