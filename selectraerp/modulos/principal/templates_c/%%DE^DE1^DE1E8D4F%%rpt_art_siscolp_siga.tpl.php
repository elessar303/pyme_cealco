<?php /* Smarty version 2.6.21, created on 2016-05-03 10:02:11
         compiled from rpt_art_siscolp_siga.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpt_art_siscolp_siga.tpl', 325, false),array('function', 'html_options', 'rpt_art_siscolp_siga.tpl', 349, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <style type="text/css">
            ...
            $(document).ready(function(){
                ...
                marca_producto=$("#marca_producto").val();
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_SiscolpSiga&producto="+producto+"&art_siscolp_siga="+art_siscolp_siga+"&marca_producto="+marca_producto,
  ...
  <!--</select>
                         ...
                         <tr>
                          <!-- CATEGORIA -->
                            ...
                            <td width="200px" style="width:200px" class="label">PRODUCTO</td>
                             <!-- PRODUCTOS -->
                            <td  style="padding-top:2px; padding-bottom: 2px; ">
                            ...
                            <td> &nbsp; </td>
                            <td width="100px" style="width:100px" class="label">ARTÍCULOS SIGA-SISCOLP</td>
                             <!-- ARTICULOS SIGA - SISCOLP -->
                            <td  style="padding-top:2px; padding-bottom: 2px; padding-left: 2px ">
                                <select name="art_siscolp_siga" id="art_siscolp_siga" style="width:200px;" class="form-text">
                                    <option value="">Todos</option>                               
                                    <option value="IN">EXISTENTES EN SISCOLP</option>
                                    <option value="OUT">FUERA DE SISCOLP</option>
                                </select>
                            </td>
                            <!-- COMENTADO HASTA QUE EL TIPO DE ALMACENAMIENTO SEA NECESARIO
                            <td> &nbsp; </td>
