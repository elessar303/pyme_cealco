<?php /* Smarty version 2.6.21, created on 2017-08-28 16:10:34
         compiled from rpt_libros_venta.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpt_libros_venta.tpl', 365, false),array('function', 'html_options', 'rpt_libros_venta.tpl', 377, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
...
/*Fin de la segunda prueba*/
            ...
            $(document).ready(function(){
                ...
                codigo_barras=$("#codigo_barras").val();
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_libro_ventas&punto="+punto+"&estados="+estados+"&desde="+desde+"&hasta="+hasta,
