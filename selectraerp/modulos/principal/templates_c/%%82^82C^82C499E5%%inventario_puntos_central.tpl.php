<?php /* Smarty version 2.6.21, created on 2017-08-28 14:37:44
         compiled from inventario_puntos_central.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'inventario_puntos_central.tpl', 362, false),array('function', 'html_options', 'inventario_puntos_central.tpl', 381, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
            ...
            $(document).ready(function(){
                ...
                /*if(punto==\'0\'){
                  ...
                  exit;
                    ...
                    $.ajax({
                            type: \'GET\',
                             data: "opt=reporte_inventarioCentral&estados="+estados+"&punto="+punto+"&fecha="+fecha+"&ubicacion="+ubicacion+"&categoria="+categoria+"&tipo_punto="+tipo_punto+"&codigo_barras="+codigo_barras,
...
' readonly class="form-text" />
                        ...
                        <tr>
                            ...
                            <td width="80px" style="width:80px" class="label">UBICACION</td>
                            <td  style="padding-top:2px; padding-bottom: 2px; ">
