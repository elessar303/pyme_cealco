<?php /* Smarty version 2.6.21, created on 2017-08-28 16:10:47
         compiled from rpt_ingresos.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpt_ingresos.tpl', 354, false),array('function', 'html_options', 'rpt_ingresos.tpl', 379, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <style type="text/css">
            ...
            $(document).ready(function(){
                ...
                hasta = hastaAux[2]+"-"+hastaAux[1]+"-"+hastaAux[0];
                    $.ajax({
                            type: \'GET\',
                             data: "opt=reporte_ingresosCentral&estados="+estados+"&punto="+punto+"&fecha="+desde+"&fecha2="+hasta,
