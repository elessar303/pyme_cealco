<?php /* Smarty version 2.6.21, created on 2017-08-28 09:15:42
         compiled from movimientos_puntos_central.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'movimientos_puntos_central.tpl', 365, false),array('function', 'html_options', 'movimientos_puntos_central.tpl', 378, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
 ...
 ?>
        ...
        <style type="text/css">
            ...
            $(document).ready(function(){
                ...
                fecha = desdeAux[2]+"-"+desdeAux[1]+"-"+desdeAux[0];
                fecha2=$("#fecha2").val();
                hastaAux = fecha2.split("-");
                fecha2 = hastaAux[2]+"-"+hastaAux[1]+"-"+hastaAux[0];
                ...
                if(punto==\'0\'){
                  ...
                  exit;
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_movimientoCentral&punto="+punto+"&fecha="+fecha+"&movimiento="+movimiento+"&tipo_punto="+tipo_punto+"&codigo_barras="+codigo_barras+"&fecha2="+fecha2,
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                this.vcampos = eval(data);
                                     $("#punto").append("<option value=\'0\'>Seleccione</option>");
                          ...
                          <td width="80px" style="width:80px" class="label">TIPOS DE ESTABLECIMIENTO</td>
                            ...
                            <td  style="padding-top:2px; padding-bottom: 2px; ">
                                ...
                                <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['option_values_tipo_punto'],'output' => $this->_tpl_vars['option_output_tipo_punto']), $this);?>
                                                        ...
                                                        <td width="80px" style="width:80px" class="label">TIPO DE MOVIMIENTO</td>
                            <td  style="padding-top:2px; padding-bottom: 2px; ">
                                <select name="movimiento" id="movimiento" style="width:200px;" class="form-text">
                                    <option value="0">Todos</option>
                                    <option value="Cargo">Entrada</option> 
                                    <option value="Traslado">Traslado</option> 
                                    <option value="Descargo">Salida</option>                                                             
                                </select>
                            </td> 

                        </tr>
                        <tr>
                                                      <td class="label">C&Oacute;DIGO DE BARAS</td>
                              <td >
