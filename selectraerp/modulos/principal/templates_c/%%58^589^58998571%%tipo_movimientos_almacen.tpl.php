<?php /* Smarty version 2.6.21, created on 2015-11-02 13:18:02
         compiled from tipo_movimientos_almacen.tpl */ ?>
<!DOCTYPE html>
<!--
...
?>
                        ...
                        <?php if ($this->_tpl_vars['cantidadFilas'] == 0): ?>
                            <tr><td colspan="5" style="text-align:center;"><?php echo $this->_tpl_vars['mensaje']; ?>
</td></tr>
                        <?php else: ?>
...
">
                                    <td style="text-align:right; padding-right: 80px; width: 150px;"><?php echo $this->_tpl_vars['campos']['id_tipo_movimiento_almacen']; ?>
</td>
                                    <td><?php echo $this->_tpl_vars['campos']['descripcion']; ?>
</td>
                                    <td><?php if ($this->_tpl_vars['campos']['operacion'] == "+"): ?>Entrada<?php elseif ($this->_tpl_vars['campos']['operacion'] == "-"): ?>Salida<?php endif; ?></td>
...
&amp;opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&amp;opt_subseccion=edit&amp;cod=<?php echo $this->_tpl_vars['campos']['id_tipo_movimiento_almacen']; ?>
...
&amp;opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&amp;opt_subseccion=delete&amp;cod=<?php echo $this->_tpl_vars['campos']['id_tipo_movimiento_almacen']; ?>
'" title="Eliminar"  src="../../../includes/imagenes/delete.gif"/>
                                    </td>
                                </tr>
                                <?php $this->assign('ultimo_cod_valor', $this->_tpl_vars['campos']['id_tipo_movimiento_almacen']); ?>
                            <?php endforeach; endif; unset($_from); ?>
                        <?php endif; ?>
                    </tbody>
                </table>
