<?php /* Smarty version 2.6.21, created on 2016-01-18 15:42:41
         compiled from divisas.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'divisas.tpl', 61, false),)), $this); ?>
<?php echo '
        ...
        <tr class="row-br">
            <td>
                <table class="tb-tit" cellspacing="0" cellpadding="1" border="0" width="100%">
                    <tbody>
                        <tr>
                        <td width="900"><span style="float:left">  <img src="../../libs/imagenes/moneda.png"  width="22" height="22" class="icon" /><?php echo $this->_tpl_vars['campo_seccion'][0]['nom_menu']; ?>
</span></td>
                        <td width="75">
                            <table style="cursor: pointer;" class="btn_bg" onClick="javascript:window.location='?opt_menu=<?php echo $_GET['opt_menu']; ?>
&opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&opt_subseccion=add&agregarMoneda=<?php echo $this->_tpl_vars['agregarMoneda']; ?>
'" name="buscar" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <td width="75">
                            <table style="cursor: pointer;" class="btn_bg" onClick="javascript:window.location='?opt_menu=<?php echo $_GET['opt_menu']; ?>
&opt_seccion=103'" name="buscar" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                    <td style="padding: 0px;" align="right"><img src="../../libs/imagenes/bt_left.gif" alt="" width="4" height="21" style="border-width: 0px;" /></td>
...
?>
    ...
    <?php else: ?>
        <tr  bgcolor="#e1e1e1">
    <?php endif; ?>
        <td ><?php echo $this->_tpl_vars['campos']['id_divisa']; ?>
</td>
...
&opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&opt_subseccion=edit&cod=<?php echo $this->_tpl_vars['campos']['id_divisa']; ?>
