<?php /* Smarty version 2.6.21, created on 2017-08-25 14:10:30
         compiled from ventas_producto_acumulado.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'ventas_producto_acumulado.tpl', 346, false),array('function', 'html_options', 'ventas_producto_acumulado.tpl', 358, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
        ...
        <style type="text/css">
            ...
            $(document).ready(function(){
                ...
                codigo_barras=$("#codigo_barras").val();
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_productoCentral_acumulado&estados="+estados+"&desde="+desde+"&hasta="+hasta+"&tipo_almacenamiento="+tipo_almacenamiento+"&codigo_barras="+codigo_barras,
