<?php /* Smarty version 2.6.21, created on 2017-08-25 13:03:54
         compiled from inventario_estados_central.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'inventario_estados_central.tpl', 362, false),array('function', 'html_options', 'inventario_estados_central.tpl', 383, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
            ...
            $(document).ready(function(){
                ...
                /*if(punto==\'0\'){
                  ...
                  exit;
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_inventarioCentralEstados&fecha="+fecha+"&ubicacion="+ubicacion+"&categoria="+categoria+"&tipo_punto="+tipo_punto+"&codigo_barras="+codigo_barras,
