<?php /* Smarty version 2.6.21, created on 2016-09-19 15:22:56
         compiled from tipo_cliente_editar.tpl */ ?>
<?php echo '
...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_tipo_cliente" value="<?php echo $this->_tpl_vars['datos_tipo_cliente'][0]['cod_tipo_cliente']; ?>
...
<tr>
    ...
    <td >
        <input type="text" name="descripcion" value="<?php echo $this->_tpl_vars['datos_tipo_cliente'][0]['descripcion']; ?>
