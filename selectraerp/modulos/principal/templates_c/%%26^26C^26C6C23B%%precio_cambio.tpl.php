<?php /* Smarty version 2.6.21, created on 2015-11-02 13:17:56
         compiled from precio_cambio.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'precio_cambio.tpl', 248, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
                        ...
                        <tr>
                            ...
                            <td colspan="5" style="padding-top:2px; padding-bottom: 2px;">
                                ...
                                <select style="width: 290px;;" name="producto" id="producto" class="form-text"> <option value="0">Seleccione...</option>
                                    <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['option_values_item'],'output' => $this->_tpl_vars['option_output_item'],'selected' => 0), $this);?>
...
'" title="Editar" src="../../../includes/imagenes/edit.gif">
                            ...
                            <!--<td  style="cursor:pointer; width:30px; text-align:center; margin-top: 100px;">
                                        <img  style="margin-top: 5px; width: 15px;" class="editar" onclick="javascript: window.location.href='?opt_menu=<?php echo $_GET['opt_menu']; ?>
&amp;opt_seccion=<?php echo $_GET['opt_seccion']; ?>
&amp;opt_subseccion=edit&amp;cod=<?php echo $this->_tpl_vars['campos']['DAY']; ?>
'" title="Editar" src="../../../includes/imagenes/edit.gif">
                                    </td>-->
                    <input type="hidden" name="option_menu" id="option_menu" value =<?php echo $_GET['opt_menu']; ?>
/>
                    <input type="hidden" name="option_section" id="option_section" value =<?php echo $_GET['opt_seccion']; ?>
/>
