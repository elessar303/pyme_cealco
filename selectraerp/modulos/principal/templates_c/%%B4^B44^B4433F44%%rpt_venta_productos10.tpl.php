<?php /* Smarty version 2.6.21, created on 2017-08-28 11:05:54
         compiled from rpt_venta_productos10.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpt_venta_productos10.tpl', 371, false),array('function', 'html_options', 'rpt_venta_productos10.tpl', 383, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
...
/*Fin de la segunda prueba*/
            ...
            $(document).ready(function(){
                ...
                codigo_barras=$("#codigo_barras").val();
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_productoSobreLimite2&punto="+punto+"&estados="+estados+"&desde="+desde+"&hasta="+hasta+"&unidades="+unidades+"&codigo_barras="+codigo_barras,
