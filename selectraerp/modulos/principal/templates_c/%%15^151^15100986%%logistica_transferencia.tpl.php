<?php /* Smarty version 2.6.21, created on 2017-02-22 14:42:56
         compiled from logistica_transferencia.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'logistica_transferencia.tpl', 185, false),array('modifier', 'date_format', 'logistica_transferencia.tpl', 264, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
                ...
                estados = $("#estado_destino").val();
                    $.ajax({
                        ...
                        success: function(data) 
                        {
                            ...
                            for (i = 0; i <= this.vcampos.length; i++) 
                            {
                                $("#punto_origen").append("<option value=\'" + this.vcampos[i].siga+ "\'>" + this.vcampos[i].nombre_punto + "</option>");
                            }
                        }
                    }); 
...
" size="30" maxlength="70" class="form-text" readonly="readonly"/>
                    ...
                    <tr>
                        <td>
                            <span style="font-family:'Verdana';font-weight:bold;"><b>Estado Origen (*)</b></span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <span style="font-family:'Verdana';font-weight:bold;"><b>Punto Origen</b></span>
                        </td>
                        <td>
                            <select name="punto_origen" id="punto_origen" class="form-text" style="width:205px" class="form-text">
                    ...
                    <tr>
                        <td>
                            <span style="font-family:'Verdana';font-weight:bold;"><b>Estado Destino (*)</b></span>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td>
                            <span style="font-family:'Verdana';font-weight:bold;"><b>Punto Destino</b></span>
                        </td>
                        <td>
                            <select name="punto_destino" id="punto_destino" class="form-text" style="width:205px" class="form-text">
                                <option value=""> Seleccione El Estado </option>
                            </select>
                        </td>
                    </tr>
...
" size="30"  class="form-text"/>
                    ...
                    <tr>
                        <td>
                            <span style="font-family:'Verdana';font-weight:bold;"><b>Fecha Planificación</b></span>
                        </td>
                        <td>
                            <input type="text" name="input_fechaplanificacion" id="input_fechaplanificacion" value='<?php echo ((is_array($_tmp=time())) ? $this->_run_mod_handler('date_format', true, $_tmp, "%d/%m/%Y") : smarty_modifier_date_format($_tmp, "%d/%m/%Y")); ?>
' size="30" maxlength="70" class="form-text" readonly="readonly"/>
