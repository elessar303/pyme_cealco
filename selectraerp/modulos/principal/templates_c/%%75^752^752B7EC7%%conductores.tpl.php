<?php /* Smarty version 2.6.21, created on 2017-08-25 12:40:04
         compiled from conductores.tpl */ ?>
<!DOCTYPE html>
<html>
    <head>
...
?>
                        ...
                        <tr>
                            <td colspan="4"><?php echo $this->_tpl_vars['mensaje']; ?>
</td>
                        </tr>
                        <?php else: ?>
...
">
                            <td align="center"><?php echo $this->_tpl_vars['campos']['cedula']; ?>
</td>
                            <td align="center"><?php echo $this->_tpl_vars['campos']['nombres']; ?>
</td>
                            <td align="center"><?php echo $this->_tpl_vars['campos']['apellidos']; ?>
</td>
                            <td align="center"><?php echo $this->_tpl_vars['campos']['telefono']; ?>
</td>
