<?php /* Smarty version 2.6.21, created on 2015-10-21 16:39:11
         compiled from tipos_movimientos_bancarios_edit.tpl */ ?>
<?php echo '
...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_tipo_movimientos_ban" value="<?php echo $this->_tpl_vars['datos_tipo_movimiento'][0]['cod_tipo_movimientos_ban']; ?>
" id="cod_tipo_movimientos_ban" >
    </td>
</tr>
<tr>
    <td valign="top"  colspan="3" width="30%" class="tb-head" >
    ...
    <td >
        <input type="text" name="descripcion" value="<?php echo $this->_tpl_vars['datos_tipo_movimiento'][0]['descripcion']; ?>
