<?php /* Smarty version 2.6.21, created on 2017-08-28 16:09:58
         compiled from rpt_venta_productos9_2.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'rpt_venta_productos9_2.tpl', 366, false),array('function', 'html_options', 'rpt_venta_productos9_2.tpl', 390, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
            ...
            $(document).ready(function(){
              ...
              $("#categoria").change(function() {
                ...
                marca_producto=$("#marca_producto").val();
                    ...
                    $.ajax({
                            type: \'GET\',
                            data: "opt=reporte_categoria_central&categoria="+categoria,
