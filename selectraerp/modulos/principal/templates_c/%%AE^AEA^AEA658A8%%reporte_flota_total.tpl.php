<?php /* Smarty version 2.6.21, created on 2017-08-24 11:45:00
         compiled from reporte_flota_total.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'reporte_flota_total.tpl', 196, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
                ...
                $("#marca").change(function() {
                        ...
                        $.ajax({
                            ...
                            success: function(data) 
                            {
                                ...
                                $("#modelo").append("<option value=\'999\'>TODOS</option>");
            ...
            function validacion()
                {
                    ...
                    document.formulario.action = "../../reportes/reporte_flota_total.php";
                    ...
                    <thead>
                        <tr>
                            <th colspan="6" class="tb-head" style="text-align:center;">
                                REPORTE GENERAL FLOTA VEHICULAR
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="padding-top:2px; padding-bottom: 2px;">
                                <select name="marca" id="marca" style="width:200px;" class="form-text">
                        ...
                        <tr>
                            <td class="label">Estatus Vehiculo</td>
                            <td colspan="3" style="padding-top:2px; padding-bottom: 2px;">
                                <select name="estatus_vehiculo" id="estatus_vehiculo" style="width:200px;" class="form-text">
                                    <option value="999">TODOS</option>            
                        ...
                        <tr>
                            <td class="label">Tipo Vehiculo</td>
                            <td colspan="3" style="padding-top:2px; padding-bottom: 2px;">
                                <select name="tipo_vehiculo" id="tipo_vehiculo" style="width:200px;" class="form-text">
                                    <option value="999">TODOS</option>
                                    <?php echo smarty_function_html_options(array('values' => $this->_tpl_vars['option_values_tipoVehiculo'],'output' => $this->_tpl_vars['option_output_tipoVehiculo']), $this);?>

                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td class="label">Herramientas</td>
                            <td colspan="3" style="padding-top:2px; padding-bottom: 2px;">
                                <select name="herramientas" id="herramientas" style="width:200px;" class="form-text">
                                    <option value="999"> TODOS </option>
                        ...
                        <tr>
                            <td class="label">Refrigerado</td>
                            <td colspan="3" style="padding-top:2px; padding-bottom: 2px;">
                                <select name="refrigerado" id="refrigerado" style="width:200px;" class="form-text">
                                    <option value="999"> TODOS </option>
                                    <option value="1"> SI </option>
                                    <option value="0"> NO </option>
