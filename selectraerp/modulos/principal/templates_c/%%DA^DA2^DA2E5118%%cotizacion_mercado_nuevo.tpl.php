<?php /* Smarty version 2.6.21, created on 2017-08-09 00:05:25
         compiled from cotizacion_mercado_nuevo.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'date_format', 'cotizacion_mercado_nuevo.tpl', 250, false),array('function', 'html_options', 'cotizacion_mercado_nuevo.tpl', 322, false),)), $this); ?>
<!DOCTYPE html>
<html>
    <head>
                                ...
                                <table class="lista" style="width:100%;">
                                    ...
                                    <tbody>
                                        <?php if ($this->_tpl_vars['cod'] == ""): ?>
                                            <?php $_from = $this->_tpl_vars['productos_cotizacion_mercado']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
