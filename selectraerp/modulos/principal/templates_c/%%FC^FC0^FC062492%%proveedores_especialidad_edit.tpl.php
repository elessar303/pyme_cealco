<?php /* Smarty version 2.6.21, created on 2017-08-24 11:23:15
         compiled from proveedores_especialidad_edit.tpl */ ?>
<?php echo '
...
" width="22" height="22" class="icon" /><?php echo $this->_tpl_vars['subseccion'][0]['especialidad']; ?>
</span></td>
                        <td width="75">
...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_especialidad" value="<?php echo $this->_tpl_vars['datos_banco'][0]['cod_especialidad']; ?>
" id="cod_especialidad" >
    </td>
</tr>
<tr>
    ...
    <td >
        <input type="text" name="especialidad" value="<?php echo $this->_tpl_vars['datos_banco'][0]['especialidad']; ?>
" size="60" id="especialidad" >
    </td>
</tr>
</table>
