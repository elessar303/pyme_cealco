<?php /* Smarty version 2.6.21, created on 2017-08-26 18:26:08
         compiled from linea_editar.tpl */ ?>
<?php echo '
...
<tr>
    ...
    <td >
        <input type="text" readonly name="cod_linea" value="<?php echo $this->_tpl_vars['campo_linea'][0]['id']; ?>
" id="cod_linea" >
    </td>
</tr>
<tr>
    ...
    <td >
        <input type="text" name="descripcion_linea" value="<?php echo $this->_tpl_vars['campo_linea'][0]['marca']; ?>
" size="60" id="descripcion_linea" >
    </td>
</tr>
</table>
