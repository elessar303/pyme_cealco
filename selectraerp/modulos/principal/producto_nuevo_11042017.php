...
if (isset($_POST["aceptar"]))
{
   ...
   if($_FILES["foto3"]["name"]!="")
    ...
    $instruccion = "
        ...
        regulado,cestack_basica,bcv,clap, unidadxpeso, unidad_venta, pesoxunidad, itempos, producto_vencimiento, tipo_almacenamiento, central, nacional, precio_bulto)
        VALUES(
        ...
        '" . $_POST["unidad_venta"]."', '" . $_POST["pesoxunidad"]."','".$idpos."','".$_POST["producto_vencimiento"]."', '".$_POST["tipo_almacenamiento"]."', '".$_POST["central"]."', '".$_POST["nacional"]."', ".$_POST["precio_bulto"].");";
