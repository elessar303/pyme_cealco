...
$cliente = new Clientes();
mysql_set_charset('utf8');
$campos3 = $cliente->ObtenerFilasBySqlSelect("SELECT * FROM departamentos");

foreach ($campos3 as $key => $item) {
    $arraySelectOption6[] = $item["cod_departamento"];
    $arraySelectOutPut6[] = $item["descripcion"];
}
$smarty->assign("option_values_departamento", $arraySelectOption6);
$smarty->assign("option_output_departamento", $arraySelectOutPut6);
