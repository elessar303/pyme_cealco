        ...
        */
        $.ajax({
            ...
            success: function(data) {
                ...
                {
                    $("#ubicacion").append("<option value='" + this.vcampos[i].id + "'>Lote:"+this.vcampos[i].lote+" - " + this.vcampos[i].descripcion + "- Etiq."+this.vcampos[i].etiqueta+" - Cantidad: "+this.vcampos[i].cantidad+" - Peso: "+this.vcampos[i].peso+"</option>");
                }
            }
        });
    }
