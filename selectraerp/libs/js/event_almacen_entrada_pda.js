    ...
    win = new Ext.Window({
        ...
        buttons:[
        {
            ...
            handler:function(){
                ...
                if($("#items").val()=="" || $("#cantidadunitaria").val()=="" || $("#instalacion").val()=="" || $("#input_fechaplanificacion_inicio").val()=="" || $("#input_fechaplanificacion_fin").val()=="" || $("#cantidadunitaria").val()=="" || $("#observacion_detalle").val()=="")
                {
                ...
                eventos_form.IncluirRegistros({
                    ...
                    input_fechaplanificacion_inicio: $("#input_fechaplanificacion_inicio").val(),
                    input_fechaplanificacion_fin: $("#input_fechaplanificacion_fin").val(),
                    observacion_detalle:        $("#observacion_detalle").val(),
                    punto_origen:         $("#punto_origen").val(),
