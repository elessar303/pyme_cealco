var eventos_form = {
    ...
    Limpiar: function() {
        ...
        $("#cantidadunitaria, #items,#items_descripcion,#codigoBarra, #almacen, #descripcionitem, #codigofabricante,#cantidadunitaria,#costounitario, #totalitem_tmp,#cantidaddeberia,#observacion,#cantidad_existente,#fVencimiento,#nlote,#fecha_vencimiento,#estatus_producto,#observacion1,#tipo_uso,#fechainicio,#fechafin").val("");
    },
    IncluirRegistros: function(options) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                campos += $.inputHidden("_fechainicio", options.fechainicio, "[]");
                campos += $.inputHidden("_fechafin", options.fechafin, "[]");
                ...
                html += "       <td>" + options.fechainicio + "</td>";
                html += "       <td>" + options.fechafin + "</td>";
