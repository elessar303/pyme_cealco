...
if (isset($_GET["opt"]) == true || isset($_POST["opt"]) == true) {
    ...
    switch ($opt) {
                    ...
                    $sql="SELECT *
                            FROM ".$BD_central.".votacion v, ".$BD_selectrapyme.".unidades u
                            WHERE  v.gerencia=u.descripcion";
                    if($estado!="0"){
                        $sql.=" and u.cod_unidad='".$estado."'";
                    }
                    if ($punto=="1") {
                        $sql.=" and v.hora_vota <> '0000-00-00 00:00:00'";
                    }
                    if ($punto=="2") {
                        $sql.=" and v.hora_vota ='0000-00-00 00:00:00'";
                    }
                    if ($territorio!="0") {
                        $sql.=" and v.territorio ='".$territorio."'";
                    }

                    //echo $sql.=" GROUP BY v.CODE ORDER BY v.nombre_producto"; Para ver el query y luego probarlo en el PHPMYADMIN
                    $sql.=" ORDER BY v.gerencia,nombre_emp";
                    //echo $sql; exit();
                    ...
                    <table border="1" align="center" style="margin-left: 10" cellpadding="1" cellspacing="0">
                        <tr bgcolor="#5084A9">
                            <td colspan="8" align="center"><b><font color="white">REPORTE DE HISTORICO DE PRECIOS: <?php echo $desde." HASTA: ".$hasta  ?></font></b></td>
                        </tr>
                        <tr bgcolor="#5084A9">
                            <td width="50px" align="center"><b><font color="white">N&deg;</font></b></td>
                            <td width="100px" align="center"><b><font color="white">CEDULA</font></b></td>
                            <td width="350px" align="center"><b><font color="white">NOMBRES Y APELLIDOS</font></b></td>
                            <td width="200px" align="center"><b><font color="white">GERENCIA</font></b></td>
                            <td width="150px" align="center"><b><font color="white">ESTADO DEL CENTRO</font></b></td>
                            <td width="150px" align="center"><b><font color="white">NOMBRE DEL CENTRO</font></b></td>
                            <td width="150px" align="center"><b><font color="white">HORA DE VOTO</font></b></td>
                        </tr>
                        </table>
                    ...
                    ?>
                        <tr>
                            ...
                            <td width="100px" align="center"><?php echo $lista["nacionalidad_emp"]."-".$lista["cedula_emp"]; ?></td>
                            <td width="350px" align="center"><?php echo utf8_encode($lista["nombre_emp"])." ".utf8_encode($lista["apellido_emp"]); ?></td>
                            <td width="200px" align="center"><?php echo utf8_encode($lista["gerencia"]); ?></td>
                            <td width="150px" align="center"><?php echo utf8_encode($lista["estado_centro"]); ?></td>
                            <td width="150px" align="center"><?php echo utf8_encode($lista["nombre_centro"]); ?></td>
                            <td width="150px" align="center"><?php echo $lista["hora_vota"]; ?></td>
                        </tr>
                    ...
                    ?>
                    <tr>
                        <td colspan="8"><hr color="black" size="2" /></td>
                    </tr>
            ...
            }// termina el reporte que no es consolidado

            break;

        case "reporte_ingresosCentral":
                    $punto = $_GET["punto"];
                    $estado = $_GET["estados"];
                    $desde = $_GET["fecha"];
                    $hasta = $_GET["fecha2"];
                    ...
                    $sql="SELECT * FROM ".$BD_central.".ingresos_central ing WHERE `fecha_deposito` BETWEEN '".$desde."' and '".$hasta."'";

                    if($punto!="0"){
                        $sql.=" and ing.codigo_siga='$punto'";
                    }
                    ...
                    <table border="1" align="center" style="margin-left: 10" cellpadding="1" cellspacing="0">
                        <tr bgcolor="#5084A9">
                            <td colspan="7" align="center"><b><font color="white">REPORTE DE INGRESOS </font></b></td>
                        </tr>
                        <tr bgcolor="#5084A9">
                            <td width="50px" align="center"><b><font color="white">N°</font></b></td>
                            <td width="150px" align="center"><b><font color="white">N° DEPOSITO</font></b></td>
                            <td width="200px" align="center"><b><font color="white">N° CATAPORTE</font></b></td>
                            <td width="150px" align="center"><b><font color="white">FECHA</font></b></td>
                            <td width="150px" align="center"><b><font color="white">MONTO DEPOSITO</font></b></td>
                            <td width="200px" align="center"><b><font color="white">CUENTA</font></b></td>
                            <td width="150px" align="center"><b><font color="white">USUARIO</font></b></td>
                        </tr>
                        </table>
                        <div style="max-height: 400px; overflow: auto;overflow: scroll;">
                    <table border="1" align="center" style="margin-left: 10" cellpadding="1" cellspacing="0">
                    <?php
                        ...
                        $i=1;
                        foreach ($reporte as $lista ) {
                            $monto=$monto+$lista['monto_deposito'];
                        ?>
                        <tr >
                            <td width="50px" align="center"><?php echo $i; ?></td>                            
                            <td width="150px" align="center"><?php echo $lista["nro_deposito"] ?></td>
                            <td width="200px" align="center"><?php echo $lista["nro_cataporte"] ?></td>
                            <td width="150px" align="center"><?php echo $lista["fecha_deposito"] ?></td>
                            <td width="150px" align="center"><?php echo number_format($lista["monto_deposito"], 2, ',', '.'); ?></td>
                            <td width="200px" align="center"><?php echo $lista["cuenta_banco"] ?></td>
                            <td width="150px" align="center"><?php echo $lista["usuario_creacion"] ?></td>
                        </tr>
                    <?php
                         $i++;
                        }
            ...
            break; 
                    ...
                    case "reporte_comprobantesCentral":
                    $punto = $_GET["punto"];
                    $estado = $_GET["estados"];
                    $desde = $_GET["fecha"];
                    $hasta = $_GET["fecha2"];
                    ...
                    $sql="SELECT * FROM ".$BD_central.".comprobante_central comp, ".$BD_central.".puntos_venta pv  WHERE comp.codigo_siga=pv.codigo_siga_punto AND `fecha` BETWEEN '".$desde." 00:00:00' and '".$hasta." 23:59:59' and observacion<>''";
                    
                    if($punto!="0"){
                        $sql.=" and comp.codigo_siga='$punto'";
                    }
                    //echo $sql; 
                    ...
                    <table border="1" align="center" style="margin-left: 10" cellpadding="1" cellspacing="0">
                        <tr bgcolor="#5084A9">
                            <td colspan="7" align="center"><b><font color="white">REPORTE DE COMPROBANTES </font></b></td>
                        </tr>
                        <tr bgcolor="#5084A9">
                            <td width="50px" align="center"><b><font color="white">N°</font></b></td>
                            <td width="150px" align="center"><b><font color="white">N° COMPROBANTE</font></b></td>
                            <td width="150px" align="center"><b><font color="white">FECHA</font></b></td>
                            <td width="150px" align="center"><b><font color="white">USUARIO</font></b></td>
                            <td width="250px" align="center"><b><font color="white">OBSERVACION</font></b></td>
                            <td width="150px" align="center"><b><font color="white">ESTABLECIMIENTO</font></b></td>
                            <td width="100px" align="center"><b><font color="white">IMPRIMIR</font></b></td>
                        </tr>
                        </table>
                        <div style="max-height: 400px; overflow: auto;overflow: scroll;">
                    <table border="1" align="center" style="margin-left: 10" cellpadding="1" cellspacing="0">
                    <?php
                        ...
                        <tr >
                            <td width="50px" align="center"><?php echo $i; ?></td>                            
                            <td width="150px" align="center"><?php echo $lista["id_comprobante"]; ?></td>
                            <td width="150px" align="center"><?php echo $lista["fecha"]; ?></td>
                            <td width="150px" align="center"><?php echo $lista["nombre_usuario"]; ?></td>
                            <td width="250px" align="center"><?php echo $lista["observacion"]; ?></td>
                            <td width="150px" align="center"><?php echo $lista["codigo_siga_punto"]." - ".$lista["nombre_punto"] ?></td>
                            <td style="cursor: pointer; width: 100px; text-align:center">
                                        <img class="impresion" onclick="javascript:window.open('../../reportes/comprobante_ingreso.php?id_transaccion=<?php echo $lista["id_comprobante"] ?>&siga=<?php echo $lista["codigo_siga_punto"] ?>', '');" title="Imprimir Detalle de Movimiento" src="../../../includes/imagenes/ico_print.gif"/>
                            </td>
                        </tr>
                    <?php
                         $i++;
         ...
         case "reporte_productoInexistenteCentral2":
                    $punto = $_GET["punto"];
                    $estado = $_GET["estados"];
                   ...
                   mc.marca as marca, um.nombre_unidad as nombre_unidad
                    ...
                    ";*/
                    $sql="SELECT i.descripcion1,ivp.codigo_barra,ivp.precio_sin_iva as precio,dos.nombre_estado as estados,icab.fecha,icab.usuario,i.pesoxunidad,m.marca as marca,i.unidadxpeso
                            FROM $BD_selectrapyme.item_variacion_precio ivp
                            INNER JOIN $BD_selectrapyme.item_variacion_precio_cabecera icab ON icab.id_var_precio_cab = ivp.id_var_precio_cab
                            INNER JOIN $BD_selectrapyme.item i ON ivp.codigo_barra=i.codigo_barras
                            INNER JOIN $BD_central.estados dos ON dos.codigo_estado = ivp.id_estado
                            INNER JOIN $BD_selectrapyme.marca m ON m.id=i.id_marca
                            WHERE  icab.fecha BETWEEN '$desde 00:00:00' and '$hasta 23:59:59'";
...
*/
                    ...
                    <table  width="100%" border="1" align="center" cellpadding="1" cellspacing="0">
                        <tr bgcolor="#5084A9">
                            <td colspan="5" align="center"><b><font color="white">REPORTE DE HISTORICO DE PRECIOS: <?php echo $desde." HASTA: ".$hasta  ?></font></b></td>
                        </tr>
                        <tr bgcolor="#5084A9">
                            ...
                            <td width="10%" align="center"><b><font color="white">ESTADO</font></b></td>
                            <td width="25%" align="center"><b><font color="white">PRECIOS</font></b></td>
                            <td width="10%" align="center"><b><font color="white">USUARIO</font></b></td>
                        ...
                        <tr>
                            ...
                            <td  align="center">
                                <?php
                                    ...
                                    echo " - ".$lista["marca"]." ";
                                    echo $lista["pesoxunidad"].$lista["unidadxpeso"];
                                    //echo $lista["unidadxpeso"]//.$lista["nombre_unidad"];
                                ?>
                            </td>
                            <td  align="center"><?php echo utf8_encode($lista["estados"]); ?></td>
                            <td align="center"><?php echo utf8_encode($lista["precio"]); ?></td>
                             <td align="center"><?php echo utf8_encode($lista["usuario"]); ?></td>
                            <td align="center"><?php echo utf8_encode($lista["fecha"]); ?></td>
        ...
        case "reporte_categoria_central":
                   ...
                   v.PRICESELL,(v.PRICESELL*t.rate) + v.PRICESELL as PRECIOIVA,t.rate
                    ...
                    ?>
                     <table border="1" align="center" style="margin-left: 10">
                        ...
                        <tr bgcolor="#5084A9">
                            ...
                            <td width="10%" align="center"><b><font color="white">CODIGO BARRA</font></b></td-->
                            <td width="20px" align="center"><b><font color="white">N°</font></b></td>
                            <td width="800px" align="center"><b><font color="white">DESCRIPCION</font></b></td>
                    ...
                    <?php
                     ...
                     ?>
                        <tr >
                            <td width="20px" align="center"><?php echo $j; ?></td>
                            
                            
                            <td width="800px" align="center"><?php echo utf8_encode($lista["descripcion"]); ?></td>
            ...
            case "reporte_productoInexistenteCentral":
                   ...
                   mc.marca as marca, um.nombre_unidad as nombre_unidad
                    ...
                    WHERE v.fecha BETWEEN '$desde' and '$hasta'
                    ";*/
                    $sql="SELECT i.descripcion1,ivp.codigo_barra,ivp.precio_sin_iva as precio,dos.nombre_estado as estados,icab.fecha, icab.correlativo as correlativo, icab.usuario, icab.fecha
                            FROM $BD_selectrapyme.item_variacion_precio ivp
                            INNER JOIN $BD_selectrapyme.item_variacion_precio_cabecera icab ON icab.id_var_precio_cab = ivp.id_var_precio_cab
                            INNER JOIN $BD_selectrapyme.item i ON ivp.codigo_barra=i.codigo_barras
                            INNER JOIN $BD_central.estados dos ON dos.codigo_estado = ivp.id_estado
...
*/
                    ...
                    //echo $sql.=" GROUP BY v.CODE ORDER BY v.nombre_producto"; Para ver el query y luego probarlo en el PHPMYADMIN
                    $sql.=" ORDER BY correlativo, i.descripcion1 ";
                    //echo $sql; exit();
                    //$sql_cod_barras.=" GROUP BY v.CODE ORDER BY v.nombre_producto";
                    //echo $sql;
                    $reporte = $conn->ObtenerFilasBySqlSelect($sql);
                    ...
                    <table border="1" align="center" style="margin-left: 10" cellpadding="1" cellspacing="0">
                        ...
                        <tr bgcolor="#5084A9">
                            ...
                            <td width="100px" align="center"><b><font color="white">CODIGO BARRA</font></b></td>
                            ...
                            <td width="100px" align="center"><b><font color="white">PRECIOS</font></b></td>
                            <td width="100px" align="center"><b><font color="white">CORRELATIVO ARCHIVO</font></b></td>
                            <td width="100px" align="center"><b><font color="white">FECHA</font></b></td>
                            <td width="100px" align="center"><b><font color="white">USUARIO</font></b></td>
                    ...
                    <table  border="1" align="center" style="margin-left: 10">
                        <tr>
                            ...
                            <td width="100px" align="center"><?php echo $lista["codigo_barra"] ?></td>
                            ...
                            <td width="100px" align="center"><?php echo utf8_encode($lista["estados"]); ?></td>
                            <td width="100px" align="center"><?php echo utf8_encode($lista["precio"]); ?></td>
                            <td width="100px" align="center"><?php echo utf8_encode($lista["correlativo"]); ?></td>
                            <td width="100px" align="center"><?php echo utf8_encode($lista["fecha"]); ?></td>
                            <td width="100px" align="center"><?php echo utf8_encode($lista["usuario"]); ?></td>
...
//$movimiento=$conn->ObtenerFilasBySqlSelect("SELECT * FROM movimientos_bancarios  WHERE id_cliente=$cliente AND monto<>monto_aplicado");
                   ...
                   //SELECCION DE LOS ESTADOS
                    ...
                    if($estado==9999)
                    {
                        ?>   <tr bgcolor="#5084A9">
                            ...
                            <td width="300px" align="center"><b><font color="white">TONELADAS</font></b></td>
                            <td width="50px" align="center"><b><font color="white">TOTAL SIN IVA</font></b></td>
                            <td width="50px" align="center"><b><font color="white">TOTAL CON IVA</font></b></td>
                            <td width="50px" align="center"><b><font color="white">CLIENTES ATENDIDOS</font></b></td>
                        </tr>
                        </table>
                        <div style="max-height: 400px; overflow: auto;overflow: scroll;">
                    <table border="1" align="center" style="margin-left: 10" cellpadding="1" cellspacing="0">
                        ...
                        <tr>
                            <td width="50px" align="center"><b><?php echo $i; ?></b></td>
                            <td width="150px" align="center"><b><?php echo $lista_estado['nombre_estado'] ?></b></td>
                            <td width="300px" align="center"><b><?php if(count($reporte)==0){echo "0,00";}else{echo number_format($totalTone, 3, ',', '.');} ?></b></td>
                            <td width="50px" align="center"><b><?php if(count($reporte)==0){echo "0,00";}else{echo number_format($totalSinIva, 2, ',', '.');}  ?></b></td>
                            <td width="50px" align="center"><b><?php if(count($reporte)==0){echo "0,00";}else{echo number_format($totalConIva, 2, ',', '.');} ?></b></td>
                            <td width="50px" align="center"><b><?php echo $totalClientes ?></b></td>
                        ...
                        <tr bgcolor="#D8D8D8">
                            <td> </td>
                            <td align="center"><b>TOTAL</b></td>
                            <td  align="center"><b><?php if(count($reporte)==0){echo "0,00";}else{echo number_format($totalTone_fin, 3, ',', '.');} ?></b></td>
                            <td  align="center"><b><?php if(count($reporte)==0){echo "0,00";}else{echo number_format($totalSinIva_fin, 2, ',', '.');}  ?></b></td>
                            <td  align="center"><b><?php if(count($reporte)==0){echo "0,00";}else{echo number_format($totalConIva_fin, 2, ',', '.');} ?></b></td>
                            <td  align="center"><b><?php echo number_format($totalCliente_fin, 0, ',', '.'); ?></b></td>
                        </tr>
                    ...
                    if($estado!=0)
                    {
                         ...
                         <tr bgcolor="#5084A9">
                            <td width="50px" align="center"><b><font color="white">N&deg;</font></b></td>
                            <td width="150px" align="center"><b><font color="white">ESTADO</font></b></td>
                            <td width="350px" align="center"><b><font color="white">ESTABLECIMIENTO</font></b></td>
                            <td width="150px" align="center"><b><font color="white">TONELADAS</font></b></td>
                            <td width="150px" align="center"><b><font color="white">TOTAL SIN IVA</font></b></td>
                            <td width="150px" align="center"><b><font color="white">TOTAL CON IVA</font></b></td>
                            <td width="100px" align="center"><b><font color="white">CLIENTES ATENDIDOS</font></b></td>
                        </tr>
                        </table>
                        <div style="max-height: 400px; overflow: auto;overflow: scroll;">
                    <table border="1" align="center" style="margin-left: 10" cellpadding="1" cellspacing="0">
                        ...
                        ?> 
                        <tr>
                            <td width="50px" align="center"><b><?php echo $j; ?></b></td>
                            <td width="150px" align="center"><b><?php echo $lista_estado['nombre_estado'] ?></b></td>
                            <td width="350px" align="center"><b><?php echo $lista_estado['nombre_punto'] ?></b></td>
                            <td width="150px" align="center"><b><?php if(count($reporte)==0){echo "0,00";}else{echo number_format($totalTone, 3, ',', '.');} ?></b></td>
                            <td width="150px" align="center"><b><?php if(count($reporte)==0){echo "0,00";}else{echo number_format($totalSinIva, 2, ',', '.');}  ?></b></td>
                            <td width="150px" align="center"><b><?php if(count($reporte)==0){echo "0,00";}else{echo number_format($totalConIva, 2, ',', '.');} ?></b></td>
                            <td width="100px" align="center"><b><?php echo $totalClientes ?></b></td>
                        </tr>
                        ...
                        <tr bgcolor="#D8D8D8">
                            ...
                            <td></td>
                            <td><b>TOTAL</b></td>
                            <td align="center"><b><?php echo number_format($totalTone_fin, 3, ',', '.'); ?></b></td>
                            <td align="center"><b><?php echo number_format($totalSinIva_fin, 2, ',', '.');  ?></b></td>
                            <td align="center"><b><?php echo number_format($totalConIva_fin, 2, ',', '.'); ?></b></td>
                            <td align="center"><b><?php echo number_format($totalCliente_fin, 0, ',', '.'); ?></b></td>
                        </tr>
            ...
            case "reporte_movimientoCentral":
                    ...
                    $anno_has=substr($_GET["fecha2"],2,2);
                    $mes_des=substr($_GET["fecha"],5,2);
                    $mes_has=substr($_GET["fecha2"],5,2);
                    ...
                    (it.pesoxunidad*um.transformar*(i.cantidad))/1000000 as tonelaje
                    ...
                    $sql.= " GROUP BY i.codigo_barras,  i.tipo_movimiento, i.cod_movimiento";
                    $sql.="  ORDER BY i.fecha,i.codigo_siga, it.descripcion1"; 
                    //echo $sql;
                    ...
                    <table border="1" align="center" style="margin-left: 10" cellpadding="1" cellspacing="0">
                        <tr bgcolor="#5084A9">
                            <td colspan="10" align="center"><b><font color="white">REPORTE DE INVENTARIO DEL: <?php echo date("d-m-Y", strtotime($desde)); ?> A <?php echo date("d-m-Y", strtotime($hasta)); ?></font></b></td>    
                        </tr>
                        <?php if($codigo_barras!=""){ ?>
                            <tr bgcolor="#5084A9">
                            <td colspan="10" align="center"><b><font color="white">PRODUCTO: <?php echo $codigo_barras; ?></font></b></td>
                        </tr>
                        <?php } ?>
                        <tr bgcolor="#5084A9">
                            <td width="50px" align="center"><b><font color="white">N&deg;</font></b></td>
                            <td width="100px" align="center"><b><font color="white">AUTORIZADO POR</font></b></td>
                            <td width="150px" align="center"><b><font color="white">CODIGO DE BARRAS</font></b></td>
                            <td width="250px" align="center"><b><font color="white">PRODUCTO</font></b></td>
                            ...
                            <td width="100px" align="center"><b><font color="white">MOVIMIENTO</font></b></td>
                            <td width="100px" align="center"><b><font color="white">UBICACION ENTRADA</font></b></td>
                            <td width="100px" align="center"><b><font color="white">UBICACION SALIDA</font></b></td>
                            <td width="100px" align="center"><b><font color="white">FECHA</font></b></td>   
                        </tr>
                        </table>
                        <div style="max-height: 400px; overflow: auto;overflow: scroll;">
                    ...
                    <?php
                     ...
                     ?>      
                        <tr>
                            <td width="50px" align="center"><?php echo $i; ?></td>
                            <td width="100px"><?php echo $lista["autorizador_por"] ?></td>
                            <td width="150px" align="center"><?php echo $lista["codigo"] ?></td>
                            ...
                            <td width="100px" align="center"><?php echo $lista["can_2"] ?></td>
                            <td width="100px" align="center"><?php echo number_format($lista["tonelaje"], 3, ',', '.');?></td> 
                            <td width="100px" align="center"><?php echo $lista["tipo_movimiento"] ?></td> 
                            <td width="100px" align="center"><?php echo $lista["ubicacion_entrada"] ?></td> 
                            <td width="100px" align="center"><?php echo $lista["ubicacion_salida"] ?></td>
                            <td width="100px" align="center"><?php echo $lista["fecha"] ?></td> 
                        </tr>  
