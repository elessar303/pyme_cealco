...
case "calcular_arqueo":
            ...
            if(!empty($fecha_inicio[0]['fecha_fin']))
            {
                ...
                if($resultado[0]['TOTAL_SISTEMA']!="0,00")
                {
                    ...
                    if($resta==0)
                    {
                        echo "0_".$resultado[0]['total_cajero']."_".$total_sistema_formato."_".$resta."_".$resultado[0]['total_efectivo_sistema']."_".$resultado[0]['total_tj_sistema']."_".$resultado[0]['total_tickets_sistema']."_".($resultado[0]['total_dev_efectivo']+$resultado[0]['total_dev_tarjeta']."_0"."_0"."_0_".$iva12."_".$iva8."_".$ivaotro."_0_0_0_".$tipoarray);
                    }
                    if($resta>0)
                    {
                        //sobrante
                        echo "1_".$resultado[0]['total_cajero']."_".$total_sistema_formato."_".$resta."_".$resultado[0]['total_efectivo_sistema']."_".$resultado[0]['total_tj_sistema']."_".$resultado[0]['total_tickets_sistema']."_".($resultado[0]['total_dev_efectivo']+$resultado[0]['total_dev_tarjeta']."_0"."_0_"."_0".$iva12."_".$iva8."_".$ivaotro."_0_0_0_".$tipoarray);
                    }
                    if($resta<0)
                    {
                        //faltante
                        echo "2_".$resultado[0]['total_cajero']."_".$total_sistema_formato."_".$resta."_".$resultado[0]['total_efectivo_sistema']."_".$resultado[0]['total_tj_sistema']."_".$resultado[0]['total_tickets_sistema']."_".($resultado[0]['total_dev_efectivo']+$resultado[0]['total_dev_tarjeta']."_0"."_0_"."_0".$iva12."_".$iva8."_".$ivaotro."_0_0_0_".$tipoarray);
                    }
